COUNTRY_COORDS = {
    ...
    "Northern Mariana Islands (The United States of America)": (15.0979, 145.6739),
...
def get_coords(name: str):
    """Return (lat, lon) for a country name, or (0, 0) if not found."""
    if not name:
        return 0.0, 0.0
    # Direct match
    ...
    for country, coords in COUNTRY_COORDS.items():
        if country.lower() in name_lower or name_lower in country.lower():
            return coords
    return 0.0, 0.0
